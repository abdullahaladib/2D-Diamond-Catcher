...
def draw_shapes():
    ...
    glColor3f(0, 1, 1)
    #glTranslatef(0, 500, 50) 
    gluSphere(gluNewQuadric(), 30, 40, 10)  # parameters are: quadric, radius, slices, stacks
...
def showScreen():
    ...
    draw_text(10, 740, f"See how the position and variable change?: x = {camera_pos[0]} y = {camera_pos[1]} z = {camera_pos[2]}")
